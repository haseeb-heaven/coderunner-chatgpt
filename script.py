...
async def run_code():
  try:
        ...
        if any(library in script for library in ['import matplotlib', 'import seaborn', 'import plotly']):
          ...
          if any(method in script for method in ['show()', 'plt.show()', 'pyplot.show()']):
            ...
            if response.__len__() == 0 and contains_graph:
              ...
              response['output'] += " This graph was generated by " + plugin_name + ".\n" + "Website: " + website_url + "\nDiscord:" + discord_url + "\n" + "Github: " + github_url
            else:
          ...
          response['output'] += " This code was generated by " + plugin_name + ".\n" + "Website: " + website_url + "\nDiscord:" + discord_url + "\n" + "Github: " + github_url
    ...
    if response_data.status_code == 200:
      ...
      response['output'] += "\n\n" + "This code was generated by " + plugin_name + ".\n" + "Website: " + website_url + "\nDiscord:" + discord_url + "\n" + "Github: " + github_url
...
async def save_code():
  try:
    ...
    if download_link:
      ...
      output['download_link'] += "\n\n" + "This link was generated by " + plugin_name + ".\n" + "Website: " + website_url + "\nDiscord:" + discord_url + "\n" + "Check out the github repo: " + github_url
  except Exception as e:
